...
import com.ead.course.domain.exceptions.EntityInUseException;
import com.ead.course.domain.exceptions.EntityNotExistsException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleBusiness(AccessDeniedException ex, WebRequest request) {
